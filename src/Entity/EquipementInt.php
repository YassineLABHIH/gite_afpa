...
#[UniqueEntity('name', message: 'Cet équipement intérieur existe déjà')]
class EquipementInt
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    ...
    #[ORM\ManyToMany(targetEntity: Gite::class, mappedBy: 'EquipementInts')]
